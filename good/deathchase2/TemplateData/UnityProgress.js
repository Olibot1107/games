var copyrightNotice = "This game is the exclusive property of licensed to Zyis Limited (owners and operators of friv.com). Unauthorized hosting is strictly prohibited.";
...
if (!gameInstance.friv) {
    gameInstance.friv = document.createElement("div");
    gameInstance.friv.className = "friv " + gameInstance.Module.splashScreenStyle;
    gameInstance.container.appendChild(gameInstance.friv);
  }
  ...
  gameInstance.progress.empty.style.width = (100 * (1 - progress/1)) + "%";
	 ...
	 //gameInstance.spinner.style.display = "inline-block";
	  ...
	  setTimeout(function(){ gameInstance.logo.style.display = gameInstance.progress.style.display = "none";
								gameInstance.spinner.style.display = "none";
								gameInstance.friv.style.display = "none";
